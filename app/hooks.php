...
add_action('delete_attachment', 'deleteAttachment');
add_filter('upload_dir', 'changeUploadDir');

/**
 * Change the upload directory
 * @return Array $dirs
 */
function changeUploadDir($dirs) {
...
/**
 * Delete media from S3 when it is deleted in WordPress
 * The function is executed before media is removed from WordPress using the delete_attachment hook
 * @param  
 * @return Null
 */
